    ...
    async fn test_01_vad_threshold_tuning() {
        ...
        loop {
            ...
            if current_stop >= current_start {
                print_error(
                    "WARNING: threshold_stop should usually be lower than threshold_start.",
                );
            }
    ...
    async fn test_03_vad_silence_duration() {
        ...
        loop {
            ...
            if !speech_seen {
                ...
                print_info(
                    "Maybe background noise is keeping VAD active (level > threshold_stop)?",
                );
            }
